      ...
      <div className="resourcePage">
        ...
        <p className="resourceP">
          {lang
            ...
            : "During the Second World War, many American soldiers came to Britain and Wilson Monk from Atlantic City was one of them. Life away from home could be very difficult for some of the young soldiers but people like Jessie Prior from Abersychan were willing to welcome them into their own homes. While Wilson Monk was in Wales, Jessie Prior because like his foster mother. As a result, a great friendship grew between Jessie and Rosita, Wilson's mum. Even at the end of the war, the two women exchanged letters from many years and because friends for life. This is an example of the kind of letter Jessie Prior wrote to Wilson's mother:  "}
        </p>
