      ...
      <div className="resourcePage">
        ...
        <p className="resourceP">
          {lang
            ...
            : "Clive Sullivan died at the age of 42 and during his life, he had to face many challenges and was often tested physically and mentally. He experienced prejudice and jealousy from others and because of his skin colour, he had to tackle racism almost daily. When dealing with all these barriers, Clive Sullivan not only managed to survive, but he also reached the top of rugby league. In doing so, he demonstrated to others that success is possible in a period of time which could be very difficult for those from minority ethnic groups. And this is why Clive ‘Sully’ Sullivan is one of Wales’s most important sports heroes!"}
        </p>
        <div
        ...
        >
          ...
          <p className="resourceP">
            {lang
              ...
              : `A portrait describes a person. It describes different aspects of that person and discusses the features particular to them. How about writing a portrait of Colin Jackson?
